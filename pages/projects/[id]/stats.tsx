        ...
        {activeTab === 'global' ? (
          <div className="global-stats-content">
            ...
            <div className="mb-8 grid grid-cols-1 gap-6 lg:grid-cols-2">
              ...
              <div className="rounded-lg border border-gray-100 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                <h3 className="mb-4 text-lg font-semibold">Expenses by Payment Method</h3>
                <div className="relative h-64">
                  {preparePaymentMethodChartData() ? (
                    <Pie data={preparePaymentMethodChartData()!} options={chartOptions} />
                  ) : (
                    <div className="flex h-full items-center justify-center text-gray-500">
            ...
            <div className="mb-8 grid grid-cols-1 gap-6">
              {/* Monthly Trends */}
              <div className="rounded-lg border border-gray-100 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                <h3 className="mb-4 text-lg font-semibold">Monthly Expense Trends</h3>
              ...
              <div className="rounded-lg border border-gray-100 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                <h3 className="mb-4 text-lg font-semibold">Expenses by Day of Week</h3>
                <div className="relative h-72">
                  {prepareDayOfWeekChartData() ? (
                    <Bar data={prepareDayOfWeekChartData()!} options={dayOfWeekChartOptions} />
                  ) : (
                    <div className="flex h-full items-center justify-center text-gray-500">
            ...
            <div className="mb-8 rounded-lg border border-gray-100 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800">
              ...
              <div className="relative h-80">
                {prepareMemberSpendingChartData() ? (
                  <Bar data={prepareMemberSpendingChartData()!} options={chartOptions} />
                ) : (
                  <div className="flex h-full items-center justify-center text-gray-500">
            ...
            {stats?.personalStats ? (
              <>
                ...
                <div className="mb-8 grid grid-cols-1 gap-6 lg:grid-cols-2">
                  ...
                  <div className="rounded-lg border border-gray-100 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                    <h3 className="mb-4 text-lg font-semibold">Your Payment Methods</h3>
                    <div className="relative h-64">
                      {preparePersonalPaymentMethodChartData() ? (
                        <Pie data={preparePersonalPaymentMethodChartData()!} options={chartOptions} />
                      ) : (
                        <div className="flex h-full items-center justify-center text-gray-500">
                          No payment method data available
                        </div>
                ...
                <div className="mb-8 rounded-lg border border-gray-100 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                  ...
                  <div className="relative h-72">
                    {preparePersonalMonthlySpendingChartData() ? (
                      <Bar data={preparePersonalMonthlySpendingChartData()!} options={chartOptions} />
                    ) : (
                      <div className="flex h-full items-center justify-center text-gray-500">
